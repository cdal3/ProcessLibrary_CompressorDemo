...
public class raP_5_20_PINTLK_NL_HMINavLoadBanks : BaseNetLogic
{
    ...
    private void LoadBanks()
    {
        ...
        const string LOGID = "Interlock HMI Nav: Load Banks";
        const string LIST_WIDGET_NAME = "raP_5_20_PINTLK_AdvHMINavList";
        const string BANK_WIDGET_NAME = "raP_5_20_PINTLK_AdvHMINavListBank";

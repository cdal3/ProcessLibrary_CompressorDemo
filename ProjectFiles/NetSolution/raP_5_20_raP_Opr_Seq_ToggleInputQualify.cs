...
public class raP_5_20_raP_Opr_Seq_ToggleInputQualify : BaseNetLogic
{

    private const string STEPS_SUFFIX = "_Steps";
    private const string INPUTS_NODE = "Inputs";
    private const string CFG_INPUTMASK = "Cfg_InputMask";
    private const string CFG_INPUTSTATE = "Cfg_InputState";

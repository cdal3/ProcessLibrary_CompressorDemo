...
public class raP_5_20_PINTLK_NL_HMIIDLoadBanks : BaseNetLogic
{
    ...
    private void LoadBanks()
    {
        ...
        const string LOGID = "Interlock HMI ID: Load Banks";
        const string LIST_WIDGET_NAME = "raP_5_20_PINTLK_AdvHMIId";
        const string BANK_WIDGET_NAME = "raP_5_20_PINTLK_AdvHMIIdBank";

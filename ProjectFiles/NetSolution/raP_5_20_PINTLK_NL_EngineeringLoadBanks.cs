...
public class raP_5_20_PINTLK_NL_EngineeringLoadBanks : BaseNetLogic
{
    ...
    private void LoadBanks()
    {
        ...
        const string LOGID = "Interlock Engineering: Load Banks";
        const string LIST_WIDGET_NAME = "raP_5_20_PINTLK_AdvEngList";
        const string BANK_WIDGET_NAME = "raP_5_20_PINTLK_AdvEngListBank";

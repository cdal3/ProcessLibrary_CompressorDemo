...
public class raP_5_20_PINTLK_NL_HMITypesLoadBanks : BaseNetLogic
{
    ...
    private void LoadBanks()
    {
        ...
        const string LOGID = "Interlock HMI: Load Banks";
        const string LIST_WIDGET_NAME = "raP_5_20_PINTLK_AdvHMITypeList";
        const string BANK_WIDGET_NAME = "raP_5_20_PINTLK_AdvHMITypeListBank";

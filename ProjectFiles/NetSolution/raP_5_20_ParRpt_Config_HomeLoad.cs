...
public class raP_5_20_ParRpt_Config_HomeLoad : BaseNetLogic
{
    ...
    {
        IUANode unifiedTypeNode = Project.Current.Find("raP_5_20_ParRpt_Grp_ParRptConfig");
        ...
        if (setPage == 0 && numPars == 0)
        {
            SetLoading(false);
            return;
        }
        else if (setPage == 1 && numRpts == 0)
        {
            SetLoading(false);
            return;
        }
